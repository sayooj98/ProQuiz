...
public class Question6 extends AppCompatActivity {
    ...
    public void correct(Button b){
        mp = MediaPlayer.create(Question6.this, R.raw.correct);
        mp.start();

        b.setBackgroundColor(Color.GREEN);
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(Question6.this);
    ...
    public void wrong(Button b,int ans){
        mp = MediaPlayer.create(Question6.this, R.raw.wrong);
        mp.start();
    ...
    public void showDialog(){
        ...
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Question6.this,MainMenu.class);
                startActivity(i);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CountDownTimer c = new CountDownTimer(13000,1000) {
            @Override
