...
public class Question2 extends AppCompatActivity {
    ...
    public void correct(Button b){
        mp = MediaPlayer.create(Question2.this, R.raw.correct);
        mp.start();

        b.setBackgroundColor(Color.GREEN);
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(Question2.this);
    ...
    public void wrong(Button b,int ans){
        mp = MediaPlayer.create(Question2.this, R.raw.wrong);
        mp.start();
    ...
    public void showDialog(){
        ...
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Question2.this,MainMenu.class);
                startActivity(i);
            }
        });
